...
<body>
	<div class="container">
		...
		<div>
			...
			<form:form method="POST" action="/index/transferAmount/${param.custid}">		
				<form:hidden path="custid"  />
					Enter Amount :
					<form:input type="text" path="Balance" required="required" /> <br><br><br>
					Enter Destination Account Number :
					<form:input type="text" path="Account_number" required="required"/> <br> <br> <br>
